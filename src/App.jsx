...
const products = [
  { id: "1", title: "Industrial Steel Pipes - Grade A", category: "construction", price: "$12 - $45", moq: "500 pieces", supplier: "Gulf Steel Industries", supplierId: "s1", country: countries[0], rating: 4.8, image: "https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?w=400", verified: true },
  { id: "2", title: "Organic Dates - Premium Medjool", category: "food", price: "$8 - $25", moq: "100 kg", supplier: "Al Madinah Dates Co.", supplierId: "s2", country: countries[1], rating: 4.9, image: "https://images.unsplash.com/photo-1614707267537-b85aaf00c4b7?w=400", verified: true },
  { id: "3", title: "LED Panel Lights - Commercial Grade", category: "electronics", price: "$15 - $60", moq: "200 units", supplier: "Noor Electronics LLC", supplierId: "s3", country: countries[0], rating: 4.6, image: "https://images.unsplash.com/photo-1565814329452-e1432bc237d1?w=400", verified: false },
  { id: "4", title: "Cotton Fabric Rolls - Premium", category: "textiles", price: "$3 - $12/m", moq: "1000 meters", supplier: "Khaleeji Textiles", supplierId: "s4", country: countries[3], rating: 4.7, image: "https://images.unsplash.com/photo-1558171813-4c088753af8f?w=400", verified: true },
  { id: "5", title: "CNC Milling Machine - 5 Axis", category: "machinery", price: "$25,000 - $80,000", moq: "1 unit", supplier: "Precision Gulf Machinery", supplierId: "s5", country: countries[1], rating: 4.5, image: "https://images.unsplash.com/photo-1565043589221-1a6fd9ae45c7?w=400", verified: true },
  { id: "6", title: "Automotive Brake Pads - OEM Quality", category: "auto", price: "$5 - $20", moq: "500 sets", supplier: "Emirates Auto Parts", supplierId: "s6", country: countries[0], rating: 4.4, image: "https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=400", verified: false },
  { id: "7", title: "Industrial Chemical Solvents", category: "chemicals", price: "$50 - $200/barrel", moq: "10 barrels", supplier: "Gulf Chem Solutions", supplierId: "s7", country: countries[2], rating: 4.3, image: "https://images.unsplash.com/photo-1532187863486-abf9dbad1b69?w=400", verified: true },
  { id: "8", title: "Designer Leather Handbags", category: "fashion", price: "$30 - $150", moq: "50 pieces", supplier: "Souq Fashion House", supplierId: "s8", country: countries[4], rating: 4.8, image: "https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=400", verified: true },
  { id: "9", title: "Crude Oil Processing Equipment", category: "oil-gas", price: "$100,000+", moq: "1 unit", supplier: "Petro Gulf Equipment", supplierId: "s1", country: countries[1], rating: 4.9, image: "https://images.unsplash.com/photo-1518709766631-a6a7f45921c3?w=400", verified: true },
  { id: "10", title: "Corrugated Packaging Boxes", category: "packaging", price: "$0.50 - $3", moq: "5000 pieces", supplier: "Pack Gulf Industries", supplierId: "s2", country: countries[0], rating: 4.2, image: "https://images.unsplash.com/photo-1607166452427-7e4477c3a9ed?w=400", verified: false },
  { id: "11", title: "Organic Fertilizers - Agricultural", category: "agriculture", price: "$20 - $80/ton", moq: "5 tons", supplier: "Green Gulf Agri", supplierId: "s3", country: countries[5], rating: 4.6, image: "https://images.unsplash.com/photo-1625246333195-78d9c38ad449?w=400", verified: true },
  { id: "12", title: "Medical Surgical Masks - N95", category: "healthcare", price: "$0.30 - $1.50", moq: "10000 pieces", supplier: "MedGulf Supplies", supplierId: "s4", country: countries[0], rating: 4.7, image: "https://images.unsplash.com/photo-1584634731339-252c581abfc5?w=400", verified: true },
];

const suppliers = [
  { id: "s1", name: "Gulf Steel Industries", logo: "🏭", country: countries[0], verified: true, description: "Leading manufacturer and supplier of premium quality steel products across the GCC region. Established in 1995 with state-of-the-art production facilities.", stats: { products: 245, responseRate: "98%", yearsActive: 28, employees: "500+" }, certifications: ["ISO 9001", "ISO 14001", "OHSAS 18001"] },
  { id: "s2", name: "Al Madinah Dates Co.", logo: "🌴", country: countries[1], verified: true, description: "Premium date supplier from the heart of Saudi Arabia. Our dates are organically grown and hand-picked for the finest quality.", stats: { products: 45, responseRate: "95%", yearsActive: 15, employees: "200+" }, certifications: ["Organic Certified", "HACCP", "ISO 22000"] },
  { id: "s3", name: "Noor Electronics LLC", logo: "💡", country: countries[0], verified: false, description: "Wholesale electronics distributor specializing in LED lighting, commercial AV equipment, and smart building solutions.", stats: { products: 890, responseRate: "92%", yearsActive: 10, employees: "150+" }, certifications: ["CE", "RoHS", "UL Listed"] },
];
